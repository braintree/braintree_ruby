...
describe Braintree::Transaction do
  ...
  context "testing" do
    it "changes transaction status to settled" do
      ...
      settle_result = Braintree::Transaction.settle(sale_result.transaction.id)
    ...
    it "changes transaction status to settlement_confirmed" do
      ...
      settle_result = Braintree::Transaction.settlement_confirm(sale_result.transaction.id)
